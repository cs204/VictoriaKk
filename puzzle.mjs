...
// Б ни чего не сказал.
let знания1 = new И()
знания1.добавить(new Эквивалентность(new И(АРыцарь, АЛжец), АРыцарь));
знания1.добавить(new Эквивалентность(АЛжец, new Не(АРыцарь)));
знания1.добавить(new Эквивалентность(new И(БРыцарь, БЛжец), БЛжец));
...
let знания2 = new И()
знания2.добавить(new Эквивалентность(new И(АРыцарь, АЛжец), АРыцарь));
знания2.добавить(new Эквивалентность(АЛжец, new Не(АРыцарь)));
знания2.добавить(new Эквивалентность(new И(БРыцарь, БЛжец), БЛжец));
...
// В сказал: "А - рыцарь."
let знания3 = new И()
знания3.добавить(new Эквивалентность(new И(АРыцарь, АЛжец), АЛжец));
знания3.добавить(new Эквивалентность(АРыцарь, new Не(АЛжец)));
знания3.добавить(new Эквивалентность(new И(БРыцарь, БЛжец), БРыцарь));
знания3.добавить(new Эквивалентность(БЛжец, new Не(БРыцарь)));
знания3.добавить(new Эквивалентность(new И(ВРыцарь, ВЛжец), ВЛжец));
